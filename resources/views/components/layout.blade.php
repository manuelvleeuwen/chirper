...
<footer class="footer footer-center p-5 bg-base-300 text-base-content text-xs">
    <div>
        <p>
            © {{ now()->year  }}
            <a href="https://manuelvleeuwen.dev">Manuel van Leeuwen</a>
            — Chirper demo built with Laravel.</p>
        <p>
            This project was made following the
            <a href="https://laravel.com/learn/getting-started-with-laravel">Laravel Bootcamp</a>
            with the purpose of learning how to build a full-stack Laravel application.
            It's hosted online for testing purposes.
        </p>
        <p>
            <strong>Disclaimer:</strong>
            Not affiliated with or endorsed by Laravel. All code, logos and styles are (indirectly) provided by the
            <a href="https://laravel.com/learn/getting-started-with-laravel">Laravel Bootcamp</a>.
        </p>
        <p>
            <strong>Data:</strong>
            All user information and chirps are wiped daily.
            Chirps are only visible to their author. There is no moderation implemented.
            As this is a demo, it is highly recommended that you do not reuse any of your existing usernames or passwords.
        </p>
        <p>
            <strong>Source:</strong>
            <a href="https://github.com/manuelvleeuwen/chirper">GitHub</a>
        </p>
    </div>
</footer>
</body>
